...
export async function middleware(request: NextRequest) {
  ...
  // Se o usuário acessa "/" e já tem token, redirecionar para /extension
  ...
  // Se o usuário acessa "/extension" e não tem token, redireciona para "/"
  ...
  // Se não for "/" ou "/extension" (ou a verificação passou), segue normalmente.
